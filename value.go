...
func (v nilValue) Bool() (bool, error)              { return false, nil }
func (v nilValue) Int() (int64, error)              { return 0, nil }
func (v nilValue) Float() (float64, error)          { return 0.0, nil }
func (v nilValue) Duration() (time.Duration, error) { return 0, nil }
func (v nilValue) String() (string, error)          { return "", nil }
func (v nilValue) Scan(interface{}) error           { return nil }
func (v nilValue) Load() interface{}                { return nil }
func (v nilValue) Store(interface{})                {}
func (v nilValue) Slice() ([]Value, error)          { return nil, nil }
func (v nilValue) Map() (map[string]Value, error)   { return nil, nil }
